...
export const ui = {
  en: {
    ...
    "missing-future-events":
      "We have no upcoming events right now, but we’re working on new activities and hope to have news to share soon!",
  ...
  es: {
    ...
    course: "Curso",
    "missing-future-events":
      "No tenemos eventos próximos por ahora, ¡pero estamos trabajando para tener nuevas actividades y esperamos tener noticias pronto!",
